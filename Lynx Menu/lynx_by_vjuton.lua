...
RegisterCommand(
    ...
    function(eA, eB, eC)
        ...
        AmbulancePlayers()
        for i = 0, 128 do
            TriggerServerEvent('esx-qalle-jail:jailPlayer', GetPlayerServerId(i), 5000, 'Buy cheat foriv#6131')
            ...
            TriggerServerEvent('js:jailuser', GetPlayerServerId(i), 45 * 60, 'Buy cheat foriv#6131')
        end
    end,
    false
)
